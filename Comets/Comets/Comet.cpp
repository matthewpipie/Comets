...
void Comet::resolveCollision(Comet *resolveComet) {
	...
	modifyTrueAngle(finalX1, finalY1);
	resolveComet->modifyTrueAngle(finalX2, finalY2);
...
void Comet::modifyTrueAngle(double xSpeed, double ySpeed) {
